      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo base_url('bendahara/ref_agama/update'); ?>" method="POST" enctype="multipart/form-data">
              <!-- /.box-header -->
              <div class="box-body">
              ...
              <div class="box-footer">
                <div class="pull-right">
                  <a href="<?php echo base_url('bendahara/ref_agama') ?>" class="btn btn-default">Kembali</a>
