...
class Ref_status extends CI_Controller {
	var $table 		= 'ref_status';
	var $judul 		= 'Referensi';
	var $sub_judul	= 'Status';
	...
	{
		$data['content']	= 'contents/bendahara/ref_status/show';
	...
	{
		$data['content']	= 'contents/bendahara/ref_status/create';
		$data['judul']		= $this->judul;
		$data['sub_judul']	= $this->sub_judul;
		$data['user']		= $this->session->userdata('username');
		$data['role']		= $this->session->userdata('role');
	...
	public function detail()
	{
		...
		$data['content']	= 'contents/bendahara/ref_status/detail';
		$data['judul']		= $this->judul;
		$data['sub_judul']	= $this->sub_judul;
		$data['user']		= $this->session->userdata('username');
		$data['role']		= $this->session->userdata('role');
	...
	public function edit()
	{
		...
		$data['content']	= 'contents/bendahara/ref_status/edit';
		$data['judul']		= $this->judul;
		$data['sub_judul']	= $this->sub_judul;
		$data['user']		= $this->session->userdata('username');
		$data['role']		= $this->session->userdata('role');		
