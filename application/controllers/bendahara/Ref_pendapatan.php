...
class Ref_pendapatan extends CI_Controller {
	...
	{
		$data['content']	= 'contents/bendahara/ref_pendapatan/show';
	...
	{
		$data['content']	= 'contents/bendahara/ref_pendapatan/create';
		$data['judul']		= $this->judul;
		$data['sub_judul']	= $this->sub_judul;
		$data['user']		= $this->session->userdata('username');
		$data['role']		= $this->session->userdata('role');
	...
	public function store()
	{
		...
		if ($insert) {
			redirect('bendahara/ref_pendapatan');
		} else {
	...
	public function detail()
	{
		...
		$data['content']	= 'contents/bendahara/ref_pendapatan/detail';
		$data['judul']		= $this->judul;
		$data['sub_judul']	= $this->sub_judul;
		$data['user']		= $this->session->userdata('username');
		$data['role']		= $this->session->userdata('role');
	...
	public function edit()
	{
		...
		$data['content']	= 'contents/bendahara/ref_pendapatan/edit';
		$data['judul']		= $this->judul;
		$data['sub_judul']	= $this->sub_judul;
		$data['user']		= $this->session->userdata('username');
		$data['role']		= $this->session->userdata('role');		
